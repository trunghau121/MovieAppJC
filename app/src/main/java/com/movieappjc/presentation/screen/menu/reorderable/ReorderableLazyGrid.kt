...
package com.movieappjc.presentation.screen.menu.reorderable
 ...
 * @param scrollMoveMode The [com.movieappjc.presentation.screen.menu.reorderable.ScrollMoveMode] that will be used to determine how other items move around when an item is dragged to the top or bottom, or start or end of the grid. See [ScrollSwapMode](sh.calvin.reorderable.ScrollSwapMode).
 ...
 * @param enabled Whether or this item is reorderable. If true, the item will not move for other items but may still be draggable. To make an item not draggable, set `enable = false` in [com.movieappjc.presentation.screen.menu.reorderable.draggable] or [Modifier.longPressDraggable] instead.
